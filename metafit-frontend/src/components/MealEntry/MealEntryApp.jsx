...
const MealEntryApp = ({ user }) => {
  ...
  const [nutritionTheme, setNutritionTheme] = useState('modern'); // modern, circular, linear, glass, gradient
  ...
  // Render nutrition based on theme
  const renderNutrition = () => {
      ...
      return (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: '33.6px', fontWeight: 'bold', color: '#fca5a5' }}>
            ...
            return (
              <div key={nut.label} style={{
                ...
                <div style={{ textAlign: 'center', marginTop: '-60px' }}>
                  <div style={{ fontSize: '18px', fontWeight: 'bold', color: nut.color }}>{nut.value}{nut.unit}</div>
                  <div style={{ fontSize: '12px', opacity: 0.7 }}>{nut.label}</div>
                </div>
              </div>
            );
          })}
    ...
    return (
      <div style={{
        ...
        <div style={{
          background: 'linear-gradient(135deg, rgba(34, 211, 238, 0.3) 0%, rgba(34, 211, 238, 0.1) 100%)',
  ...
  return (
    <div style={{
      ...
      <div style={{
        display: 'grid',
        gridTemplateColumns: '384px 480px 1fr',
        gap: '24px',
        maxWidth: '1920px',
        margin: '0 auto'
      }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ fontSize: '15.6px', fontWeight: 'bold', marginBottom: '9.6px' }}>
            Items                 Quantity (g)
          </div>
                ...
                return (
                  ...
                  >
                    <div style={{
                      ...
                      marginBottom: '12px',
                      color: '#fff',
                      borderBottom: '1px solid rgba(132, 204, 23, 0.2)',
                      paddingBottom: '9.6px'
                    }}>
                      {preset.Name}
                    </div>
